...
Elm.Stamps.make = function (_elm) {
   ...
   var drawStamp = function (stamp) {
      return function () {
         ...
         function (x) {
            return function ($) {
               return $Graphics$Collage.rotate(dir(x))($Graphics$Collage.move(origin(x))((_U.eq(xflipped(x),
               1) ? $Util.flipX : $Basics.identity)($)));
            };
         },
         stamp.pattern));
      }();
         ...
         p) {
            ...
            0) ? function () {
               ...
               return {ctor: "_Tuple2"
                      ...
                      {ctor: "_Tuple2",_0: e,_1: s})};
            }() : function () {
               var edge = $Util.sideToEdge(A2($Util.get,
               side,
               shape));
               ...
               return {ctor: "_Tuple2"
                      ,_0: side$
                      ,_1: A2($Util.fromRelativeCoords,
                      $Util.negateY(A2($Util.toRelativeCoords,
                      p,
                      edge)),
                      edge$)};
            }();
   ...
   var adjacentFlip = function (shape) {
      return function () {
   ...
   var oppositeFlip1 = function (shape) {
      return function () {
         var n = $List.length(shape);
         var innerFunction = F2(function (side,
         p) {
   ...
   var oppositeFlip = function (shape) {
      return function () {
         var n = $List.length(shape);
         var innerFunction = F2(function (side,
         p) {
   ...
   size) {
      return function () {
         var angle = $Basics.pi - $Util.exteriorAngle(n);
         return $List.map($Util.edgeToSide)(A2($List.scanl,
         makeEdge(size),
         {ctor: "_Tuple2"
         ,_0: {ctor: "_Tuple2"
              ,_0: 0
   ...
   rotation) {
      return function () {
         ...
         function (x) {
            return 2 * $Basics.pi * x / 3 - $Basics.pi / 6 + rotation;
         },
         _L.range(1,3));
   ...
   var makeHex2Pattern = F2(function (sideLen,
   rotation) {
      return function () {
         var angles = A2($List.map,
         function (x) {
   ...
   var makeHex2Stamp = F2(function (size,
   rotation) {
      return function () {
         var pattern = A2(makeHex2Pattern,
         size,
         rotation);
         var shape = A2(ngon,6,size);
   ...
   var makeHex3Pattern = F2(function (sideLen,
   rotation) {
      return function () {
         var angles = A2($List.map,
         function (x) {
                  ...
                  return A2($List.map,
                    function (x) {
                       return {ctor: "_Tuple3"
                              ...
                              _v44._1 + $Basics.pi / 6,
                              {ctor: "_Tuple2",_0: 0,_1: 0})))
                              ,_1: $Util.rem2pi(rotation + _v44._1 + 2 * $Basics.pi / 3)
                              ,_2: 0};
                    },
                    angles);}
               _U.badCase($moduleName,
               "on line 72, column 36 to 167");
            }();
         };
         return $Set.toList(A3(addNeighbors,
         neighbors,
                  ...
                  return A2($List.map,
                    function (x) {
                       return {ctor: "_Tuple3"
                              ...
                              _v54._1 + $Basics.pi / 4,
                              {ctor: "_Tuple2",_0: 0,_1: 0})))
                              ,_1: $Util.rem2pi(_v54._1 + rotation + $Basics.pi)
                              ,_2: 0};
                    },
                    angles);}
               _U.badCase($moduleName,
               "on line 93, column 36 to 163");
            }();
         };
         return $Set.toList(A3(addNeighbors,
         neighbors,
   ...
   var makeSquare3Pattern = F2(function (sideLen,
   rotation) {
      return function () {
         var chordLen = sideLen * $Basics.sqrt(2);
         var angles = A2($List.map,
                  ...
                  return A2($List.map,
                    function (x) {
                       return {ctor: "_Tuple3"
                              ...
                              _v59._1 + $Basics.pi / 4,
                              {ctor: "_Tuple2",_0: 0,_1: 0})))
                              ,_1: $Util.rem2pi(rotation + _v59._1 + $Basics.pi)
                              ,_2: 0};
                    },
                    angles);}
               _U.badCase($moduleName,
               "on line 103, column 36 to 163");
            }();
         };
         return $Set.toList(A3(addNeighbors,
         neighbors,
   ...
   var makeSquare3Stamp = F2(function (size,
   rotation) {
      return function () {
         var pattern = A2(makeSquare3Pattern,
         size,
         rotation);
         var shape = A2(ngon,4,size);
         var link = oppositeFlip(shape);
         return {_: {}
                ,link: link
                ,pattern: pattern
                ,shape: shape};
   ...
   var makeSquare4Pattern = F2(function (sideLen,
   rotation) {
      return function () {
         var chordLen = sideLen * $Basics.sqrt(2);
         var angles = A2($List.map,
   ...
   var makeSquare4Stamp = F2(function (size,
   rotation) {
      return function () {
         var pattern = A2(makeSquare4Pattern,
         size,
         rotation);
         var shape = A2(ngon,4,size);
         var link = adjacentFlip(shape);
         return {_: {}
                ,link: link
                ,pattern: pattern
                ,shape: shape};
   ...
   var makeSquare5Pattern = F2(function (sideLen,
   rotation) {
      return function () {
         var chordLen = sideLen * $Basics.sqrt(2);
         var angles = A2($List.map,
   ...
   var makeSquare5Stamp = F2(function (size,
   rotation) {
      return function () {
         var pattern = A2(makeSquare5Pattern,
         size,
         rotation);
         var shape = A2(ngon,4,size);
         var link = oppositeFlip1(shape);
         return {_: {}
                ,link: link
                ,pattern: pattern
                ,shape: shape};
   ...
   rotation) {
      return function () {
         var orient = function (_v74) {
            return function () {
               switch (_v74.ctor)
               {case "::":
                  switch (_v74._1.ctor)
                    {case "::":
                       switch (_v74._1._1.ctor)
                         {case "::":
                            return _L.fromArray([{ctor: "_Tuple2"
                                                 ,_0: _v74._0
                                                 ,_1: 1}
         ...
         _L.range(1,3));
         var neighbors = function (_v82) {
            return function () {
               switch (_v82.ctor)
               {case "_Tuple3":
                  switch (_v82._0.ctor)
                    {case "_Tuple2":
                       return $List.map(function (_v89) {
                            return function () {
                               switch (_v89.ctor)
                               {case "_Tuple2":
                                  return {ctor: "_Tuple3"
                                         ...
                                         2)};}
                               _U.badCase($moduleName,
                               "on line 136, column 80 to 141");
                            }();
                         })(orient(angles));}
                    break;}
               _U.badCase($moduleName,
               "on line 136, column 48 to 161");
            }();
         };
         return $Set.toList(A3(addNeighbors,
         neighbors,
   ...
   rotation) {
      return function () {
         var pattern = A2(makeTrianglePattern,
         size,
         rotation);
         var shape = A2(ngon,3,size);
         var link = makeTriangleLink(shape);
         return {_: {}
                ,link: link
                ,pattern: pattern
                ,shape: shape};
   ...
   _elm.Stamps.values = {_op: _op
                        ...
                        ,makeHex3Pattern: makeHex3Pattern
                        ,makeSquarePattern: makeSquarePattern
                        ,makeSquare2Pattern: makeSquare2Pattern
                        ,makeSquare3Pattern: makeSquare3Pattern
                        ,makeSquare4Pattern: makeSquare4Pattern
                        ,makeSquare5Pattern: makeSquare5Pattern
                        ,makeTrianglePattern: makeTrianglePattern
                        ,opposite: opposite
                        ,oppositeFlip: oppositeFlip
                        ,oppositeFlip1: oppositeFlip1
                        ,adjacent: adjacent
                        ,adjacentFlip: adjacentFlip
                        ...
                        ,makeSquare3Stamp: makeSquare3Stamp
                        ,makeSquare4Stamp: makeSquare4Stamp
                        ,makeSquare5Stamp: makeSquare5Stamp
...
Elm.Util.make = function (_elm) {
   ...
   _v8) {
      return function () {
         ...
         {case "::": switch (_v8._1.ctor)
              {case "::":
                 return _U.eq(_v8._1._1,
                   _L.fromArray([])) ? _L.fromArray([A2(f,
                   _v8._0,
                   _v8._1._0)]) : A2($List._op["::"],
                   A2(f,_v8._0,_v8._1._0),
                   A2(mapBetween,
                   f,
                   A2($List._op["::"],
                   _v8._1._0,
   ...
   var get = F2(function (i,_v18) {
      return function () {
         ...
         {case "::": return _U.eq(i,
              ...
              _v18._1);}
         _U.badCase($moduleName,
         "on line 122, column 17 to 51");
      }();
   });
   var minimumBy = F2(function (f,
   xs) {
      return function () {
         var xs$ = A2($List.map,f,xs);
         return _U.cmp($List.length(xs$),
         0) > 0 ? $Maybe.Just(A2(get,
         A2(getIndexOf,
         function () {
            var _v22 = $List.minimum(xs$);
            switch (_v22.ctor)
            {case "Just": return _v22._0;}
            _U.badCase($moduleName,
            "on line 140, column 43 to 79");
         }(),
         xs$),
         xs)) : $Maybe.Nothing;
      }();
   ...
   var middleList = function (xs) {
      return $List.drop(1)(A2($List.take,
      $List.length(xs) - 1,
      xs));
   };
   var insertList = F3(function (i,
   v,
   l) {
      return A2($Basics._op["++"],
      A2($List.take,i,l),
   ...
   var end = function (xs) {
      return function () {
         var _v24 = $List.head($List.reverse(xs));
         switch (_v24.ctor)
         {case "Just": return _v24._0;}
         _U.badCase($moduleName,
         "on line 107, column 10 to 57");
      }();
   };
   var dot = F2(function (_v26,
   _v27) {
      return function () {
         switch (_v27.ctor)
         {case "_Tuple2":
            return function () {
                 switch (_v26.ctor)
                 {case "_Tuple2":
                    return _v26._0 * _v27._0 + _v26._1 * _v27._1;}
                 _U.badCase($moduleName,
                 "on line 104, column 23 to 36");
              }();}
         _U.badCase($moduleName,
         "on line 104, column 23 to 36");
      }();
   });
   var mag = function (_v34) {
      return function () {
         switch (_v34.ctor)
         {case "_Tuple2":
            return $Basics.sqrt(Math.pow(_v34._0,
              2) + Math.pow(_v34._1,2));}
         _U.badCase($moduleName,
         "on line 101, column 13 to 26");
      }();
   };
   var proj = F2(function (v,r) {
      return A2(dot,v,r) / mag(v);
   });
   _op[".-"] = F2(function (_v38,
   _v39) {
      return function () {
         switch (_v39.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v38._1 - _v39._1};}
                 _U.badCase($moduleName,
                 "on line 94, column 23 to 33");
              }();}
         _U.badCase($moduleName,
         "on line 94, column 23 to 33");
      }();
   });
   _op[".+"] = F2(function (_v46,
   _v47) {
      return function () {
         switch (_v47.ctor)
         {case "_Tuple2":
      ...
      return function () {
         ...
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: k * _v54._1};}
         _U.badCase($moduleName,
         "on line 86, column 17 to 25");
      }();
   });
   _op["./"] = F2(function (_v58,
   k) {
      return function () {
         switch (_v58.ctor)
         {case "_Tuple2":
   ...
   var toRelativeCoords = F2(function (p,
   _v62) {
      return function () {
         switch (_v62.ctor)
         {case "_Tuple2":
   ...
   var fromRelativeCoords = F2(function (_v66,
   _v67) {
      return function () {
         switch (_v67.ctor)
         {case "_Tuple2":
   ...
   var distSquared = F2(function (_v74,
   _v75) {
      return function () {
         switch (_v75.ctor)
         {case "_Tuple2":
            return function () {
                 switch (_v74.ctor)
                 {case "_Tuple2":
                    return Math.pow(_v74._0 - _v75._0,
                      2) + Math.pow(_v74._1 - _v75._1,
                      2);}
                 _U.badCase($moduleName,
   ...
   var distPointEdge = F2(function (_v82,
   _v83) {
      return function () {
         switch (_v83.ctor)
         {case "_Tuple2":
                           ...
                           {case "_Tuple2":
                              return function () {
                                   ...
                                   var edge = {ctor: "_Tuple2"
                                              ,_0: _v83._1._0 - _v83._0._0
                                              ,_1: _v83._1._1 - _v83._0._1};
                                   var $ = edge,
                                   xEdge = $._0,
                                   yEdge = $._1;
                                   ...
                                   ,_1: xEdge},
                                   {ctor: "_Tuple2"
                                   ,_0: _v82._0 - _v83._0._0
                                   ,_1: _v82._1 - _v83._0._1}));
                                   var parallelProj1 = $Basics.abs(A2(proj,
                                   edge,
                                   {ctor: "_Tuple2"
                                   ,_0: _v83._0._0 - _v82._0
                                   ,_1: _v83._0._1 - _v82._1}));
                                   var parallelProj2 = $Basics.abs(A2(proj,
                                   edge,
                                   {ctor: "_Tuple2"
                                   ,_0: _v83._1._0 - _v82._0
                                   ,_1: _v83._1._1 - _v82._1}));
                                   ...
                                   {ctor: "_Tuple2"
                                   ,_0: _v82._0
                                   ,_1: _v82._1}) : _U.cmp(parallelProj2,
                                   distBetweenEnds) > 0 ? A2(dist,
                                   {ctor: "_Tuple2"
                                   ,_0: _v83._0._0
                                   ,_1: _v83._0._1},
   ...
   var edgeToSide = function (_v98) {
      return function () {
         switch (_v98.ctor)
         {case "_Tuple2":
            return _L.fromArray([_v98._0
                                ,_v98._1]);}
         _U.badCase($moduleName,
   ...
   _elm.Util.values = {_op: _op
                      ...
                      ,unitize: unitize
                      ,perp: perp
                      ,toRelativeCoords: toRelativeCoords
                      ,fromRelativeCoords: fromRelativeCoords
                      ,negateY: negateY
                      ,flipX: flipX
                      ,flipY: flipY};
   return _elm.Util.values;
